...
<CardGroup cols={2}>
  ...
  <Card title="Profile Sync" icon="duotone arrows-rotate" href="/ask-sunny/profile-sync">
  ...
  <Card title="Artifacts" icon="duotone box" href="/ask-sunny/artifacts">
    Rich content delivered inline in messages via WebSocket. Parse embedded JSON for doctor profiles and structured data.
  </Card>
  <Card title="Key Concepts" icon="duotone lightbulb" href="/ask-sunny/concepts">
...
<CardGroup cols={2}>
  <Card title="Quickstart guide" icon="duotone rocket" href="/ask-sunny/quickstart">
  ...
  <Card title="Concepts" icon="duotone lightbulb" href="/ask-sunny/concepts">
