...
**Or use the unified API with automatic authentication:**
...
<body>
  ...
  <script type="module">
    ...
    // Automatically handles SAML/OIDC authentication
    createSunnyChat({
      container: document.getElementById("sunny-chat"),
      auth: {
        type: "saml",
...
For production applications with user authentication, you can use the unified `createSunnyChat` API:
