...
- **[Key Concepts](/ask-sunny/concepts)** - Understand events, state management, and MCP approvals
- **[Authentication](/ask-sunny/authentication)** - Set up authenticated sessions
- **[API Reference](/ask-sunny/api-reference/api-reference/authentication/token-exchange)** - WebSocket schemas and artifact type definitions
