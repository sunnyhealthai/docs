...
interface AuthUpgradeInsurance {
  partner_plan_id?: string; // UUID from Sunny Central -- provide this OR plan_alias
  plan_alias?: string;      // developer-defined alias -- provide this OR partner_plan_id
  member_id: string;
  group_id: string;
}
```
...
Manage your partner's plans and aliases from the Sunny Central dashboard. Reach out to your Sunny integration owner if you need a plan or alias added.
