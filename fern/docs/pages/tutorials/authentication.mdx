...
The easiest way to add authentication is using the unified `createSunnyChat` API with SAML/OIDC:
...
1. Trigger SAML/OIDC login (popup or redirect)
2. Connect directly to the WebSocket URL
