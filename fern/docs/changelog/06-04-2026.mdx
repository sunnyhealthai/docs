...
`partner_plan_id` continues to work unchanged. Manage your partner's plans and aliases from the Sunny Central dashboard. See [Profile Sync → Insurance](/ask-sunny/profile-sync#insurance) for the full type definition.
